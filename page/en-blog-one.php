...
$xx = explode( '-', SLUG );
$id = (int) $xx[0];
$page = cached( 'https://my.profitpay.one/api/sys/news.json?id=1-a5ea36973b3611a8d9b37ce8f2c2140a&public=1&uid='.$id );
$page = $page['data'][0];
$blog = cached( 'https://my.profitpay.one/api/sys/news.json?id=1-a5ea36973b3611a8d9b37ce8f2c2140a&public=1&show=6&lang=ru' );
